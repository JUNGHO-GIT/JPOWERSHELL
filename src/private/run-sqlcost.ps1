...
$global:projectPath = "C:\JUNGHO\2.IDE\2.Vscode\Workspace\2.Project\2.Node\JNODE"
$global:exePath = "src/js/mysql2-cost.js"
$global:sqlInput = ""
$global:sqlFilePath = ""
...
& {
	[T]::PrintLine("Green")
	[T]::PrintText("Green", "▶ EXPLAIN 할 SELECT 쿼리를 그대로 복사/붙여넣기 하세요.")
